...
public readonly struct IPNetwork : IIPNetworkBase<IPNetwork, IPAnyAddress>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryParse(ReadOnlySpan<char> source, out IPNetwork result)
    {
        if (source.Contains(':'))
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IPNetwork Parse(ReadOnlySpan<char> source) => FormattingHelper.Parse<IPNetwork>(source);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IPNetwork Parse(string source) => FormattingHelper.Parse<IPNetwork>(source);
